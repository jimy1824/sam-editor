...
function SamLocalEditorHatRight(props){
                ...
                <div className='row' style={{width:"100%"}}>
                    <div className="btn-group" role="group" aria-label="Basic example" style={{width:"100%"}}>
                        <button type="button" className="btn btn-secondary" onClick={() => {
                            onComponentClick('hat_dot_left_right')
                        }}>Left Dot
                        </button>
                        <button type="button" className="btn btn-secondary" onClick={() => {
                            onComponentClick('hat_dot_right_right')
                        }}>Right Dot
                        </button>
                        <button type="button" className="btn btn-secondary" onClick={() => {
                            onComponentClick('hat_upper_part_right')
                        }}>Upper Cap
                        </button>
                        <button type="button" className="btn btn-secondary" onClick={() => {
                            onComponentClick('hat_lower_part_right')
                        }}>Lower Shade
                        </button>
                        <button type="button" className="btn btn-secondary" onClick={() => {
                            onComponentClick('hat_top_button_right')
                        }}>Top Button
                        </button>
                    </div>
                    {colorShow &&
...
export default SamLocalEditorHatRight;
