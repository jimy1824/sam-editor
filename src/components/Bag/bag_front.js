...
import SamLocalEditorBagBack from "./bag_back";
...
function SamLocalEditorBagFront(props) {
    let {id} = props.match.params
    const [product, setProduct] = useState(null);
    useEffect(() => {
        getProductDetail(id)
            .then(items => {
                localStorage.setItem('front_view_bag', JSON.stringify(items.front_view_bag));
                localStorage.setItem('back_view_bag', JSON.stringify(items.back_view_bag));
                setProduct(items)
            })
    }, [])
        ...
        <div>
            ...
            <div>
                ...
                <div className='row'>
                    ...
                    {/*        onComponentClick('bag_handle_front')*/}
                    {/*    }}>Bag Handle*/}
                    {/*    </button>*/}
                    {/*    <button type="button" className="btn btn-secondary" onClick={() => {*/}
                    {/*        onComponentClick('bag_top_front_body')*/}
                    {/*    }}>Bag Top Section*/}
                    {/*    </button>*/}
                    {/*    <button type="button" className="btn btn-secondary" onClick={() => {*/}
                    {/*        onComponentClick('bag_mid_front_body')*/}
                    {/*    }}>Bag Mid Section*/}
                    {/*    </button>*/}
                    {/*    <button type="button" className="btn btn-secondary" onClick={() => {*/}
                    {/*        onComponentClick('bag_bottom_front_body')*/}
                    {/*    }}>Bag Bottom Section*/}
                    {/*    </button>*/}
                    {/*</div>*/}
...
export default SamLocalEditorBagFront;
